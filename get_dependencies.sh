...
# Download bcftools
wget https://github.com/samtools/bcftools/releases/download/1.16/bcftools-1.16.tar.bz2 -P -P $dependency_path
...
# Download htslib
wget https://github.com/samtools/htslib/releases/download/1.16/htslib-1.16.tar.bz2 -P -P $dependency_path
